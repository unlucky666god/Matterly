...
def materials():
    materials_data = [
        ...
        {
            "name": "TPU",
            "type": "Резино-подобный",
            "description": "Сочетает гибкость, эластичность, превосходную стойкость к износу. Изделия из этого материала способны растягиваться до 600% от изначальной длинны.",
            "properties": ["Гибкий", "Эластичный", "Износостойкий", "Химически стойкий"]
        }
    ]
